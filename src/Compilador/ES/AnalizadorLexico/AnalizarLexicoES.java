...
public class AnalizarLexicoES {
    ...
    private void AnalizarLexico(String ProgramaFuente){
        ...
        Compilador.ES.AnalizadorLexico.Lexer analisisLexico = new Compilador.ES.AnalizadorLexico.Lexer(new StringReader(ProgramaFuente));
