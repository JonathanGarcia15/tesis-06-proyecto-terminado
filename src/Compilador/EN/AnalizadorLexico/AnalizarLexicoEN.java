...
public class AnalizarLexicoEN {
    ...
    private void AnalizarLexico(String ProgramaFuente){
        ...
        Compilador.EN.AnalizadorLexico.Lexer analisisLexico = new Compilador.EN.AnalizadorLexico.Lexer(new StringReader(ProgramaFuente));
